                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <strong><input type="checkbox" name="site_title" /> {{trans('file.Site Title')}}</strong>&nbsp;
...
<script type="text/javascript">
    ...
    var site_title = <?php echo json_encode($general_setting->site_title) ?>;
		...
		$.each(qty, function(index){
			...
			while(i < qty[index]){
                if(i % 2 == 0)
                    htmltext +='<tr>';
				htmltext +='<td>';
                if($('input[name="site_title"]').is(":checked"))
                    htmltext += '<strong>'+site_title + '</strong><br>';
				...
				if( $('input[name="promo_price"]').is(":checked") && promo_price[index])
					htmltext += 'price: '+promo_price[index]+'<br>';
				else if($('input[name="price"]').is(":checked") && !promo_price[index])
