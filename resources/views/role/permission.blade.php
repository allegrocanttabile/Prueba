						    ...
						    <table class="table table-bordered table-striped permission-table">
						        ...
						        <tr>
						            ...
						            <td colspan="5">
						                ...
						                <span style="display:inline-block;">
					                    	...
					                    	<input type="checkbox" value="1" class="checkbox" name="money-transfer" checked>
					                    	@else
					                    	<input type="checkbox" value="1" class="checkbox" name="money-transfer">
					                    	@endif
						                    </div>
						        ...
						        <tr>
						            ...
						            <td class="text-center">
						                ...
						                <input type="checkbox" value="1" class="checkbox" name="billers-index" checked>
						                @else
						                <input type="checkbox" value="1" class="checkbox" name="billers-index">
						                @endif
						            	</div>
						            </td>
						            <td class="text-center">
						                ...
						                <input type="checkbox" value="1" class="checkbox" name="billers-add" checked>
						                @else
						                <input type="checkbox" value="1" class="checkbox" name="billers-add">
						                @endif
						            	</div>
						            </td>
						            <td class="text-center">
						                ...
						                <input type="checkbox" value="1" class="checkbox" name="billers-edit" checked>
						                @else
						                <input type="checkbox" value="1" class="checkbox" name="billers-edit">
						                @endif
						            	</div>
						            </td>
						            <td class="text-center">
						                ...
						                <input type="checkbox" value="1" class="checkbox" name="billers-delete" checked>
						                @else
						                <input type="checkbox" value="1" class="checkbox" name="billers-delete">
						                @endif
						            	</div>
						            </td>
						        </tr>
						        ...
						        <tr>
						            ...
						            <td colspan="5">
						            	<span style="display:inline-block;">
					                    	...
					                    	<input type="checkbox" value="1" class="checkbox" name="warehouse" checked>
					                    	@else
					                    	<input type="checkbox" value="1" class="checkbox" name="warehouse">
					                    	@endif
						                    </div>
						                ...
						                <span style="display:inline-block;">
					                    	...
					                    	<input type="checkbox" value="1" class="checkbox" name="brand" checked>
					                    	@else
					                    	<input type="checkbox" value="1" class="checkbox" name="brand">
					                    	@endif
						                    </div>
